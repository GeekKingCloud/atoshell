# Atoshell Agent Context

This file preserves the project-specific agent contract that previously lived in the root AGENTS.md. The root AGENTS.md is now a compact index; load this file for product boundaries, workflow rules, command expectations, and project-specific operating constraints.
...
**For AI assistants:** See [docs/operandi/style.md](docs/operandi/style.md) for command patterns and project conventions.
